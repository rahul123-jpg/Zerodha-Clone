    ...
    <div className="container">
      ...
      >
        <div className="col-6 p-3 text-center">
          <img
            src="images/images/nithinKamath.jpg"
        ...
        <div className="col-6 p-3">
          <p>
            People Nithin bootstrapped and founded Zerodha in 2010 to overcome
            ...
            <p> Connect on  <a style={{textDecoration:"none"}} href="" >Homepage</a>
