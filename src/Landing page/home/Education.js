...
function Education() {
  return (
      ...
      <div className='row'>
        <div className='col-6'> 
          <img src='images/images/education.svg ' style={{width:"90%"}}/>
          </div>  
          <div className='col-6'>      
          <h1 className='mb-3 fs-2'>Free and market open education</h1>
          <p>“Varsity, the largest online stock market
           education book in the world covering everything from the basics to advanced trading.”</p>
              <a href='' style={{textDecoration:"none"}}>varsity
               ...
               <p className='mt-5'> “TradingQnA, the most active trading and investment community 
