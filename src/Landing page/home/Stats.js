    ...
    <div className='container p-5'>
      <div className='row p-5'>
        <div className='col-6 p-5'>
          ...
          <p className='text-muted'> thats's why 1.3 crore customers trust Zerodha with 3.5+ lakh crores 
            worth of equality investments</p>
          ...
          <p className='text-muted'>Apart from the investment platform, we offer tools like Nudge and Kill Switch
             that help you build better investing habits.</p>
        </div>
        <div className='col-6'>
          <img src='images/images/ecosystem.png' style={{widht:"90%"}}/>
